<template>
  <div class="shop-header" v-if="info.supports">
    ...
    <!--优惠-->
    <div class="shop-header-discounts" @click="showSupports=true"> <!--优惠-->
      <div class="discounts-left">
        <div class="activity " :class="supportColors[info.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="showSupports">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="supportColors[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
...
<script>
  ...
  export default {
    data () {
      return {
        supportColors:['activity-green','activity-red','activity-orange'],
        showBulletin: false,
        showSupports: false
      }
    },
